...
if( empty( $event_img ) )
{
    $event_img    =   'https://placeholdit.imgix.net/~text?txtsize=33&w=360&h=210';
}
    ...
    <div class="lp-listing">
        <div class="lp-listing-top">
            ...
            <div class="lp-listing-top-thumb event-grid-thumb">
                <a href="<?php echo $listing_url; ?>"><img src="<?php echo $event_img; ?>" alt="<?php echo $event_title; ?>"></a>
            </div>
        </div>
        <div class="lp-listing-bottom">
            ...
            <h4><a href="<?php echo $listing_url; ?>"><?php echo $event_title; ?></a></h4>
            <?php
            if( !empty( $event_loc ) ):
            ?>
