                ...
                <div class="lp-general-section-title-outer lp_ads_payment_summary">
                    ...
                    <div class="lp-ad-click-inner  lp-ad-statcs margin-bottom-30">
						...
						<?php  if( !empty($showSpotlightAds)){ ?>
                            <li class="spotlight">
                                <h5><?php echo esc_html__('SPOTLIGHT', 'listingpro'); ?>  <span></span></h5>
                            </li>
						<?php } ?>
						<?php  if( !empty($showSearchtopAds)){ ?>
                            <li class="searchpage">
                                <h5><?php echo esc_html__('TOP OF SEARCH', 'listingpro'); ?>  <span></span></h5>
                            </li>
						<?php } ?>
						<?php  if( !empty($showDetailpageAds)){ ?>
                            <li class="detailpage">
                                <h5><?php echo esc_html__('SIDE OF LISTING', 'listingpro'); ?>  <span></span></h5>
                            </li>
						<?php } ?>
							<?php
								if(!empty($isTax)){
								...
								if(!empty($showPaypal)){
									?>
										<li class="clearfix">
											...
											<div class="lp-payement-method-name">
												<h4><?php echo esc_html__('PayPal', 'listingpro'); ?></h4>
											</div>
										</li>
										<?php
								}
								if(!empty($showStripe)){
									?>
										<li class="clearfix">
											...
											<div class="lp-payement-method-name">
												<h4><?php echo esc_html__('Stripe', 'listingpro'); ?></h4>
											</div>
										</li>
										<?php
								}
								if(!empty($showWire)){
									?>
										<li class="clearfix">
											...
											<div class="lp-payement-method-name">
												<h4><?php echo esc_html__('Wire', 'listingpro'); ?></h4>
											</div>
										</li>
										<?php
								}
