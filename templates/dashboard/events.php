            ...
            <div class="lp-listing-selecter clearfix background-white margin-bottom-general-form">
                ...
                <div class="form-group col-sm-6 ">
                    <div class="lp-listing-selecter-drop">
                        <select id="event-listing" name="event-listing" class="form-control select2-ajax-unique">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-12 ">
                                    <div class="">
                                        ...
                                        <input type="text" class="form-control" name="event-location" id="event-location" placeholder="<?php echo esc_html__('e.g. Country, City, Location', 'listingpro'); ?>">
                                    </div>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-12 ">
                                    <div class="">
                                        ...
                                        <input id="event-ticket-url" name="event-ticket-url" type="text" class="form-control" placeholder="<?php echo esc_html__('e.g. CLICK HERE', 'listingpro'); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
