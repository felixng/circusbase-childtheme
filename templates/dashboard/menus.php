    ...
    <div class="panel with-nav-tabs panel-default lp-dashboard-tabs col-md-12 lp-left-panel-height">
        ...
        if( $count_m_listings == 0 ):
            ...
            <div class="lp-blank-section">
                <div class="col-md-9 blank-left-side">
                    ...
                    <button data-form="menu" class="lp-add-new-btn add-new-open-form"><span><i class="fa fa-plus" aria-hidden="true"></i></span><?php echo esc_html__('Add new menu', 'listingpro'); ?> </button>
                </div>
            ...
            <div class="lp-menu-step-one margin-top-20">
                <div class="lp-add-menu-outer clearfix">
                    <h5><?php esc_html_e('All Menu','listingpro'); ?></h5>
                                            ...
                                            <div id="tabs-menu-<?php echo $lid; ?>" class="menu-tabs">
                                                <ul>
                                                    ...
                                                    foreach ( $lp_listing_menus as $menu_type => $lp_listing_menu ):
                                                        $tab_counter++;
                                                        $menu_type_count    +=   count($menu_type);
                                                        ?>
                                                ...
                                                foreach ( $lp_listing_menus as $menu_type => $lp_listing_menu ):
                                                    ...
                                                    <div id="tabs-menu-type-<?php echo $tab_counterr; ?>">
                                                        ...
                                                        foreach ( $lp_listing_menu as $menu_group => $listing_menu ):
                                                            $menu_groups_count    +=   count($menu_group);
                                                            ?>
                                                            <h6><?php echo $menu_group; ?></h6>
                                                            <?php
                                                            foreach ( $listing_menu as $k => $lp_menu ):

                                                                $menu_items_count    +=   count($k);
                                                                ...
                                                                <div class="lp-menu-close-outer">
                                                                    <div class="lp-menu-closed clearfix ">
                                                                        ...
                                                                        <span class="lp-dot-extra-buttons"><i class="fa fa-ellipsis-h" aria-hidden="true"></i>
                                                                            <ul class="lp-user-menu list-style-none">
                                                                                <li><a class="edit-menu-item" data-menuID="<?php echo $menu_id; ?>" data-uid="<?php echo $user_id; ?>" href=""><i class="fa fa-pencil" aria-hidden="true"></i><span><?php echo esc_html__( 'Edit', 'listingpro' ); ?></span></a></li>
                                                                                <li><a href="" class="menu-del del-this" data-LID="<?php echo $lp_menu['mListing']; ?>" data-targetid="<?php echo $menu_id; ?>" data-uid="<?php echo $user_id; ?>"><i class="fa fa-trash" aria-hidden="true"></i><span><?php echo esc_html__( 'Delete', 'listingpro' ); ?></span></a></li>
                                                                            </ul>
					                                                    </span>
                                                                    </div>
                                                                    <div id="menu-update-<?php echo $menu_id; ?>" class="lp-menu-form-outer background-white" style="display: none">
                                                                            ...
                                                                            <form class="row">
                                                                                    ...
                                                                                    <div class="lp-menu-form-feilds">
                                                                                        <div class="row clearfix">
                                                                                            <div class="col-md-8">
                                                                                                <div class="margin-bottom-10">
                                                                                                    ...
                                                                                                    <input name="menu-title-<?php echo $menu_id; ?>" id="menu-title-<?php echo $menu_id; ?>" type="text" class="form-control" placeholder="<?php echo esc_html__('Ex: Roasted Chicken', 'listingpro'); ?>" value="<?php echo $lp_menu['mTitle']; ?>">
                                                                                                </div>
                                                                                                <div class="margin-bottom-10">
                                                                                                    <label for="menu-detail-<?php echo $menu_id; ?>"><?php echo esc_html__( 'Short Description', 'listingpro' ); ?></label>
                                                                                                    <textarea name="menu-detail-<?php echo $menu_id; ?>" id="menu-detail-<?php echo $menu_id; ?>" type="text" class="form-control" rows="3" placeholder="<?php echo esc_html__('Ex: Roasted Chicken', 'listingpro'); ?>"><?php echo $lp_menu['mDetail']; ?></textarea>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-md-4">
                                                                                                <div class="jFiler-input-dragDrop pos-relative">
                                                                                                    <input type="hidden" id="dis-old-img-<?php echo $menu_id; ?>" value="<?php echo $lp_menu['mImage']; ?>">
                                                                                                    <div class="upload-field dashboard-upload-field edit-upload-<?php echo $menu_id; ?>">
                                                                                                        <?php echo do_shortcode('[frontend-button]'); ?>
                                                                                                        <?php
                                                                                                        if( !empty( $lp_menu['mImage'] ) ):
                                                                                                            ?>
                                                                                                            <img class="lp-uploaded-img event-old-img-<?php echo $menu_id; ?>" src="<?php echo $lp_menu['mImage']; ?>" alt="">
                                                                                                        <?php endif; ?>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-sm-6">
                                                                                                ...
                                                                                                <input name="menu-old-price-<?php echo $menu_id; ?>" id="menu-old-price-<?php echo $menu_id; ?>" type="text" class="form-control" placeholder="<?php echo esc_html__('Ex: $10', 'listingpro'); ?>" value="<?php echo $lp_menu['mOldPrice']; ?>">
                                                                                            </div>
                                                                                            <div class="col-sm-6">
                                                                                                <label for="menu-new-price-<?php echo $menu_id; ?>"><?php echo esc_html__( 'Sale Price', 'listingpro' ); ?></label>
                                                                                                <input id="menu-new-price-<?php echo $menu_id; ?>" name="menu-new-price-<?php echo $menu_id; ?>" type="text" class="form-control"  placeholder="<?php echo esc_html__('Ex: $10', 'listingpro'); ?>" value="<?php echo $lp_menu['mNewPrice']; ?>">
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="lp-invoices-all-stats-on-off">

                                                                                            <span><?php echo esc_html__( 'Popular Item', 'listingpro' ); ?></span>
                                                                                            <label class="switch">
                                                                                ...
                                                                                <div class="clearfix lp-choose-menu">
                                                                                    <div class="lp-listing-selecter-drop form-group clearfix margin-bottom-0 lp-new-cat-wrape col-sm-6">
                                                                                        ...
                                                                                        <select id="menu-type-<?php echo $menu_id; ?>" name="menu-type-<?php echo $menu_id; ?>" class="form-control select2">
                                                                                            <?php
                                                                                    ...
                                                                                    <div class="lp-listing-selecter-drop col-sm-6">
                                                                                        ...
                                                                                        <select id="menu-group-<?php echo $menu_id; ?>" name="menu-group-<?php echo $menu_id; ?>" class="form-control select2">
                                                                                            <?php
                                                                                ...
                                                                                <div class="lp-menu-save-btns clearfix">
                                                                                    ...
                                                                                    <button data-LID="<?php echo $lp_menu['mListing']; ?>" data-menuID="<?php echo $menu_id; ?>" data-uid="<?php echo $user_id; ?>" class="lp-save-btn lp-edit-menu"><?php echo esc_html__( 'save', 'listingpro' ); ?></button>
                                                                                </div>
                                                                            </form>
                                                                        </div>
                                                                    </div>
        ...
        <div style="display: none;" id="menu-form-toggle" class="lp-menu-step-two margin-top-20">
                            ...
                            <form class="row">
                                ...
                                <div class="clearfix lp-choose-menu">
                                    <div class="lp-listing-selecter-drop form-group clearfix margin-bottom-0 lp-new-cat-wrape col-sm-6">
                                        ...
                                        <input style="display: none;" type="text" class="form-control" name="menu-type-new" id="menu-type-new" placeholder="menu type">
                                    ...
                                    <div class="lp-listing-selecter-drop col-sm-6 clearfix">
                                        ...
                                        <input style="display: none;" type="text" class="form-control" name="menu-group-new" id="menu-group-new" placeholder="menu group">
            ...
            <div class="col-md-3 padding-right-0">
                <div class="lp-menu-right-outer lp-ad-click-outer">
                    <div class="lp-menu-right-outer-content">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/admin/menuright.png" />
                        <p><?php esc_html_e('"Your time is limited, so dont waste it living someone else life." - Steve Jobs -','listingpro'); ?></p>
                    </div>
                </div>
            </div>
